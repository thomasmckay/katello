...
angular.module('Bastion.activation-keys').config(['$stateProvider', function ($stateProvider) {
    ...
    .state('activation-keys.new.form', {
        url: '/activation-keys/new',
        collapsed: true,
        controller: 'ActivationKeyFormController',
        templateUrl: 'activation-keys/new/views/activation-key-new-form.html'
    });
    ...
    .state('activation-keys.details.actions', {
        url: '/actions',
        collapsed: true,
        templateUrl: 'activation-keys/details/views/activation-key-actions.html'
    });
